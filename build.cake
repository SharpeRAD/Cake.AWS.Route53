...
// Define directories.
var buildDir = "./src/Route53/bin/" + configuration;
var buildTestDir = "./src/Route53.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-AWS-Route53-v" + semVersion + ".zip";
...
{
    // Addin
    CopyFileToDirectory(buildDir + "/Cake.AWS.Route53.dll", binDir);
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.AWS.Route53.nuspec", new NuGetPackSettings
    {
        Version = version,
